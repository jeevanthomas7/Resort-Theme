...
import { Maximize, Bed, Users, ChefHat, ConciergeBell, Flame, Waves, ShieldCheck, Tv, Wine, ChevronLeft, ChevronRight, ArrowRight } from 'lucide-react';
import TestimonialSection from '../components/sections/TestimonialSection';

const images = [
  "/images/presidential/p4.webp",
  "/images/presidential/p2.jpg",
  "/images/presidential/p3.jpg"
];

export default function PresidentialRoom() {
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-stretch mb-10">
            ...
            <div className="lg:col-span-7 relative group rounded-2xl overflow-hidden shadow-2xl h-[350px] sm:h-[450px] lg:h-[600px] w-full border border-primary/10">
              <a href={images[currentIdx]} className="glightbox block w-full h-full" data-gallery="presidential">
                <img 
                  id="main-room-img" 
              ...
              <div className="hidden">
                {images.map((img, idx) => (
                  <a key={idx} href={img} className="glightbox" data-gallery="presidential"></a>
                ))}
              </div>
            </div>
            ...
            <div className="lg:col-span-5 flex flex-col bg-cream/30 p-8 sm:p-12 rounded-[2.5rem] border border-primary/10">
              <div className="mb-8 font-inter">
                <span className="text-accent text-[11px] font-bold tracking-[0.4em] uppercase block mb-4">Ultimate Luxury</span>
                <h2 className="font-serif text-4xl sm:text-5xl text-primary leading-tight mb-6 font-bold tracking-tight">Royal Presidential Suite</h2>
                <p className="text-text/70 text-sm sm:text-base leading-relaxed font-sans">
                  The ultimate expression of prestige and privacy. Our Presidential Suite spans the entire top floor, featuring multiple living zones, a private fireplace, and panoramic floor-to-ceiling glass walls that offer the resort's absolute finest views of the Himalayan range.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-y-6 gap-x-4 border-y border-primary/10 py-8 mb-8 font-inter">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-primary font-bold text-xs uppercase tracking-widest">3500 SQFT</span>
                </div>
                <div className="flex items-center gap-3">
                  <Bed className="w-5 h-5 text-accent" />
                  <span className="text-primary font-bold text-xs uppercase tracking-widest">3 King Beds</span>
                </div>
                <div className="flex items-center gap-3">
                  <Users className="w-5 h-5 text-accent" />
                  <span className="text-primary font-bold text-xs uppercase tracking-widest">4-6 Guests</span>
                </div>
                <div className="flex items-center gap-3">
                  <ChefHat className="w-5 h-5 text-accent" />
                  <span className="text-primary font-bold text-xs uppercase tracking-widest">Private Chef</span>
                </div>
              </div>
          ...
          <div className="mb-0 py-10">
            <h3 className="font-serif text-3xl text-primary font-bold mb-12 text-center lg:text-left tracking-tight">VIP Amenities</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 text-center lg:text-left">
              <div className="flex flex-col items-center lg:items-start gap-4 group">
                ...
                <span className="text-primary font-bold text-[10px] uppercase tracking-widest font-inter">Personal Butler</span>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-4 group">
                <div className="w-12 h-12 rounded-2xl bg-cream border border-primary/5 flex items-center justify-center text-accent group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                  <Flame className="w-6 h-6" />
                </div>
                <span className="text-primary font-bold text-[10px] uppercase tracking-widest font-inter">Private Fireplace</span>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-4 group">
                <div className="w-12 h-12 rounded-2xl bg-cream border border-primary/5 flex items-center justify-center text-accent group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                  <Waves className="w-6 h-6" />
                </div>
                <span className="text-primary font-bold text-[10px] uppercase tracking-widest font-inter">Indoor Pool</span>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-4 group">
                <div className="w-12 h-12 rounded-2xl bg-cream border border-primary/5 flex items-center justify-center text-accent group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                  <ShieldCheck className="w-6 h-6" />
                </div>
                <span className="text-primary font-bold text-[10px] uppercase tracking-widest font-inter">Elite Security</span>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-4 group">
                <div className="w-12 h-12 rounded-2xl bg-cream border border-primary/5 flex items-center justify-center text-accent group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                  <Tv className="w-6 h-6" />
                </div>
                <span className="text-primary font-bold text-[10px] uppercase tracking-widest font-inter">Home Cinema</span>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-4 group">
                <div className="w-12 h-12 rounded-2xl bg-cream border border-primary/5 flex items-center justify-center text-accent group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                  <Wine className="w-6 h-6" />
                </div>
                <span className="text-primary font-bold text-[10px] uppercase tracking-widest font-inter">Wine Cellar</span>
              </div>
            </div>
          </div>
